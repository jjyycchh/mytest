...
(function ($) {
    $.smallslider = function (elm, options) {
        ...
        _this.init = function () {
            ...
            _this.$prev.css({top:(Math.ceil((_this.opts.height-120)/2)),width:_this.opts.scale*58,height:_this.opts.scale*120,'background-size':_this.opts.scale*58+'px '+_this.opts.scale*120+'px'});
            _this.$next.css({top:(Math.ceil((_this.opts.height-120)/2)),width:_this.opts.scale*58,height:_this.opts.scale*120,'background-size':_this.opts.scale*58+'px '+_this.opts.scale*120+'px'});
