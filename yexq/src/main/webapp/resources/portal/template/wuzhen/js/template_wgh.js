...
var MyTemplate = function(){
	...
	var initLanguage = function(){
		...
		LANG_DATA.push(['#siteColumnModuleBox1 span', {cn:$('#siteColumnModuleBox1 span').text(), en:'Wisdom Wuzhen free WiFi'}, 'text']);
		...
		LANG_DATA.push(['a.android', {cn:$('a.android').text(), en:'Download'}, 'text']);
		LANG_DATA.push(['a.ios', {cn:$('a.ios').text(), en:'Download'}, 'text']);
	};
