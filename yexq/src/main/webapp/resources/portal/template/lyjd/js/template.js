...
var MyTemplate = function(){
	...
	var imageSpanBlock = function(){
		if($('div#siteImageSpanModule').length>0){
			...
			$('div#siteImageSpanModule img').height(width-20);
			$('div#siteImageSpanModule div.imageSpanTitle').width(width);*/
			$('div#siteImageSpanModule ul li').height(PTPL_MAX_WIDTH/3-20);
			$('div#siteImageSpanModule img').height(PTPL_MAX_WIDTH/3-20);
	...
	var imageTJBlock = function(){
		if($('div#siteImageTJModule').length>0){
			...
			$('div#siteImageTJModule img').height(PTPL_MAX_WIDTH/3-20);
		}
	}	
