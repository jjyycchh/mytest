...
$(document).ready(function(){
	...
	$(document).on('click', 'a#compeditdom', function(){
		if(!$(this).hasClass('disabled')){
			...
			if(__edit_moduleid=='siteLogoViewModuleBox'||__edit_moduleid=='siteBottomModule'||__edit_moduleid=='siteSliderModuleBox'||__edit_moduleid=='siteImageSpanModule'||__edit_moduleid=='siteImageTextModuleBox'||__edit_moduleid=='siteImageTJModule'){
