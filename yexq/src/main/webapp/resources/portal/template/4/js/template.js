...
var MyTemplate = function(){
	...
	var resetImageText = function(){
		...
		var width   = $('div#siteImageTextModuleBox').width()/2;
			...
			$('div#siteImageTextModuleBox ul li div').css({height:imwidth+20});
...
function loadDefaultJavascript(){
	$(document).ready(function(){
		MyTemplate.init();
		//$('div#siteLoadingModuleBox').css({height:200}).show();
	});
}
...
$(document).ready(function(){
	...
	$(document).on('click', 'a#compeditdom', function(){
		if(!$(this).hasClass('disabled')){
			...
			if(__edit_moduleid=='siteSliderModuleBox'||__edit_moduleid=='siteImageTextModuleBox'){
				var loadhtml = $(editImageTextModuleHtml);
			}else if(__edit_moduleid=='siteLinkBlockModuleBox'||__edit_moduleid=='siteTextBlockModuleBox'){
