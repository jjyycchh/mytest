var frame_title_text = "Chinanet-free";
var frame_footer_text = "版权所有 © 浙江公众信息产业有限公司";
...
$(".Bottom-Copy-Right").html(frame_footer_text);
...
var MAIN_MENU = new function() {
	this.ALL_MENUS = [{'name': ' 帐号概览', 'id': 'id_mm_overview', 'icon':'glyphicon glyphicon-home', 'dest_url': '/account/account_overview26.htm'},
	                  {'name': ' 设备管理', 'id': 'id_mm_device', 'icon':'glyphicon glyphicon-subtitles', 'dest_url': '/device/devicelist26.htm'},
	                  {'name': ' WiFi门户', 'id': 'id_mm_portal', 'icon':'glyphicon glyphicon-globe', 'dest_url': '/merchant/sites26.htm'},
	                  {'name': ' 用户管理', 'id': 'id_mm_user', 'icon':'glyphicon glyphicon-tower', 'dest_url': '/user/users26.htm'},
	                  {'name': ' 统计分析', 'id': 'id_mm_statistics', 'icon':'glyphicon glyphicon-stats', 'dest_url': '/system/statistics26.htm'},
	                  {'name': ' 帐号管理', 'id': 'id_mm_account', 'icon':'glyphicon glyphicon-user', 'dest_url': '/account/account_management26.htm'},
	                  {'name': ' 系统设置', 'id': 'id_mm_system', 'icon':'glyphicon glyphicon-fire', 'dest_url': '/system/platformsettings26.htm'},
	                  {'name': ' 商户设置', 'id': 'id_mm_merchant', 'icon':'glyphicon glyphicon-leaf', 'dest_url': '/merchant/smspurchasemgmt26.htm'},
	                  ];
