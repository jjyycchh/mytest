...
<link href="${pageContext.request.contextPath}/resources/portal/template/1/css/default.css" rel="stylesheet" media="screen">
<style>
.popover{
max-height:900px;
margin-top:335px;
        ...
        <div class="wifi-policy-site">
            ...
            <form class="form-horizontal" role="form">                  
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                <label for="SiteName" class="col-sm-2 control-label" style="text-align:right;padding-top:7px;">站点名称</label>
                ...
                <div class="col-sm-2">
                 ...
                 <div class="col-sm-3" style="padding:0px;float:right;width:196px;">
                  <button type="button" class="btn btn-primary" id="SavePortalSiteButton">保存站点</button>
                  <button type="button" class="btn btn-primary" id="SavePortalSiteButtonAS">站点另存为</button>               
              </div>
...
<script type="text/javascript">var __OwnerType = '${sessionScope.login_account_info.type}';$(document).ready(function(){MAIN_MENU.setActiveMenuItem("id_mm_portal");portalJS.init();onPortalSiteEditor.init();getSiteAllData("${siteid}")})</script>
