...
<div class="Page-Navigator-Body">
    ...
    <a href="/merchant/portalpolicies26.htm" class="initAjax">广告推送</a>

    <a href="/merchant/addportalpolicy26.htm" class="Action-Primary ChinaNet-Right End-Button initAjax">添加新策略</a>
</div>
<!-- ./Navigator -->
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/merchant/js/portalpolicy.js"></script>
