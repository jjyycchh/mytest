...
<div class="ChinaNet-Free-Menu-Left">
    ...
    <a href="/system/searchreportpage26.htm" id="searchreportpage" class="initAjax Active"><span>举报记录管理</span></a>
        ...
        <div class="ChinaNet-Search-Body">
            <div class="ChinaNet-Form-Sheet">
                <div class="Form-Item-Input ChinaNet-Col-3">
                    <input type="text" id="keywords" class="Input-Control" placeholder="关键字">
                </div>
				...
				<div class="ChinaNet-Left ChinaNet-Col-2">
					<input type="text" id="type_select" name="type_select">
				</div>
				<div class="ChinaNet-Col-1 ChinaNet-Left">
              		<button id="btn_search_report" class="Form-Primary"><span>查询</span></button>
          		</div>
          	<!-- 	<div class="ChinaNet-Col-1 ChinaNet-Left Form-Item-Label" id="total_reports">
          		</div> -->
            </div>          
        </div>
        <div class="Statis-Body">
            <div class="Statis-Body-Guest">
				<div id="report_list" class="ChinaNet-Free-Table">
					<table>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/merchant/js/reportmgmt.js"></script>
<script type="text/javascript">
	$(document).ready(function(){
		reportsearchApp.init();
	 });
</script>