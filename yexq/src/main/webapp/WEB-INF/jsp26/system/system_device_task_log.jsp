        ...
        <div class="ChinaNet-Search-Body">
            <div class="ChinaNet-Form-Sheet">
				...
				<div class="ChinaNet-Col-1 ChinaNet-Left">
              		<button id="btn_Search_devicelog" class="Form-Primary"><span>查询</span></button>
          		</div>
            ...
            <div class="Statis-Body-Guest">
				...
				<div id="elog_list" class="ChinaNet-Free-Table">
					<table>
						...
						<tbody id="deviceloglist_body"></tbody>
					</table>
				</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/merchant/js/devicetasklogmgmt.js"></script>
<script type="text/javascript">
	$(document).ready(function(){
		devicetasklogsearchApp.init();
	 });
</script>