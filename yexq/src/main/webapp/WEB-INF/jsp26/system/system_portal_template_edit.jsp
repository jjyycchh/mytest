...
<div class="Page-Navigator-Body">
    ...
    <a href="/system/portaltemplatemanagement26.htm" class="initAjax">模板设置</a>
    <a href="#">模板编辑</a>
...
<div class="ChinaNet-Free-Menu-Left">
    ...
    <a href="/system/portaltemplatemanagement26.htm" id="portaltemplatemanagement" class="initAjax Active"><span>模板设置</span></a>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/merchant/js/portalmgmtedit.js"></script>
