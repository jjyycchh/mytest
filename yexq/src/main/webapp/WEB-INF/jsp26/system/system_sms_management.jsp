...
<div class="ChinaNet-Free-Menu-Left">
    ...
    <a href="/merchant/smsmanagement26.htm" id="smsmanagement" class="initAjax Active"><span>短信管理</span></a>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/merchant/js/smssendlog.js"></script>
