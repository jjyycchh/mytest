...
<div class="ChinaNet-Free-Menu-Left">      
    ...
    <s:if test="#session.login_account_info.type != 'MANUFACTURER'">
        <a href="/system/radiusvirtualdevicepage26.htm" id="radiusvirtualdevicepage" class="initAjax Active"><span>AAA认证设备管理</span></a>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/merchant/js/radiusvirtualdevice.js"></script>
