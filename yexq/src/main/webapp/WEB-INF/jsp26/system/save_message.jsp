...
<div class="ChinaNet-Free-Menu-Left">
    ...
    <a href="/system/sentmessage26.htm" id="sentmsg" class="initAjax"><span>已发信息</span></a>
    <a href="/system/sendoutmessage26.htm" id="savemsg" class="initAjax Active"><span>发送信息</span></a>
</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/merchant/js/savemessage.js"></script>
