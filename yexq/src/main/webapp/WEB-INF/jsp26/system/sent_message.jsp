...
<div class="ChinaNet-Free-Menu-Left">
    <a href="/system/get_message26.htm" id="showmsg" class="initAjax "><span>收件箱</span></a>
    <a href="/system/sentmessage26.htm" id="sentmsg" class="initAjax Active"><span>已发信息</span></a>
    <a href="/system/sendoutmessage26.htm" id="savemsg" class="initAjax"><span>发送信息</span></a>
</div>
				...
				<div class="ChinaNet-Free-Table">
					<table>
						<tr class="ChinaNet-Table-Title">
						    <th width="20%">信息接收者</th>
							<th width="20%">信息标题</th>
							<th width="30%">信息内容</th>
							<th width="25%">接收时间</th>		
							<th class="Width-For-Button">&nbsp;</th>						
						</tr>
						<tbody id="sentMsglist">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/merchant/js/sentmessage.js"></script>
