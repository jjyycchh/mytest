...
<div class="Page-Navigator-Body">
    ...
    <a href="#">系统设置</a>
    <a href="#">客户端软件管理</a>
    <a href="/system/applicationmanagementpage26.htm" class="Action-Primary End-Button ChinaNet-Right initAjax">返回APP列表</a>
</div>
<!-- ./Navigator -->
    ...
    <div id="systemBody" class="Right-Body-Main">
        <!-- <div class="Account-Avatar-Editor">
                    <div class="Avatar-Image-Body Data-Adorn-Overly">
                        ...
                        <div class="Avatar-Image-Sheet"><img src="/resources/merchant/img/no-image.png" id="AccountAvatarThumb"></div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/merchant/js/applicationupload.js"></script>
