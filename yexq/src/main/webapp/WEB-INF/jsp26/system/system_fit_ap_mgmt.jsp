...
<div class="ChinaNet-Free-Menu-Left">      
    ...
    <s:if test="#session.login_account_info.type != 'MANUFACTURER'">
        ...
        <a href="/system/fitapdevicepage26.htm" id="fitapdevicepage" class="initAjax Active"><span>Fit-Ap设备管理</span></a>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/merchant/js/fitapdevice.js"></script>
