...
<link type="text/css" href="${pageContext.request.contextPath}/resources/merchant/css/statis.css" rel="stylesheet" media="screen">
<!-- Navigator -->
...
<div class="ChinaNet-Free-Menu-Left">
    <a href="/user/userstatistics26.htm" id="userstatistics" data-element="statisticsBody" class="initAjax"><span>基于用户分析</span></a>
    <a href="/merchant/trafficstatis26.htm" id="trafficstatis" data-element="statisticsBody" class="initAjax"><span>基于AP分析</span></a>
    <a href="/merchant/portalsstatis26.htm" id="portalsstatis" data-element="statisticsBody" class="initAjax"><span>广告推送分析</span></a>
</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/merchant/js/statis.js"></script>
