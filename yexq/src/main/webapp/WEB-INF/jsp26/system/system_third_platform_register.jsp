...
<div class="Page-Navigator-Body">
    ...
    <a href="#">系统设置</a>
    <a href="#">二级平台管理</a>
    <a href="/platform10/searchthirdplatformpage26.htm" class="Action-Primary End-Button ChinaNet-Right initAjax">返回二级平台列表</a></div>
<!-- ./Navigator -->
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/merchant/js/thirdplatformregister.js"></script>
