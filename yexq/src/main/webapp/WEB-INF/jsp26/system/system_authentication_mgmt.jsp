    ...
    <div id="systemBody" class="Right-Body-Main">
        <div class="ChinaNet-Search-Body">
            <div class="ChinaNet-Form-Sheet">
				...
				<!-- <div class="ChinaNet-Left ChinaNet-Col-2">
					<input type="text" id="typeSelect" name="typeSelect">
				</div> -->
				<div class="ChinaNet-Col-1 ChinaNet-Left">
              		<button id="btn_Search_authen" class="Form-Primary"><span>查询</span></button>
          		</div>
            </div>          
        </div>
        <div class="Statis-Body">
            <div class="Statis-Body-Guest">
            	<!-- Working Statis -->
				<div id="authen_list" class="ChinaNet-Free-Table">
					<table>
						<tr class="ChinaNet-Table-Title">
							<th  width="25%">终端MAC地址</th>
							<th  width="30%">下线时间</th>
							<th  width="20%">上行流量</th>
							<th  width="20%">下行流量</th>
							<th class="Width-For-Button"></th>					
						</tr>
						<tbody id="authenlist_body"></tbody>
					</table>
				</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/merchant/js/userauthmgmt.js"></script>
<script type="text/javascript">
	$(document).ready(function(){
		userauthmgmtApp.init();
	 });
</script>