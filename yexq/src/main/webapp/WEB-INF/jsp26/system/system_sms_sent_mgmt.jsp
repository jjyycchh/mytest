    ...
    <div id="systemBody" class="Right-Body-Main">
        ...
        <div class="Statis-Body">
            <div class="Statis-Body-Guest">
            	<!-- Working Statis -->
				<div id="sms_list" class="ChinaNet-Free-Table">
					<table>
						<tr class="ChinaNet-Table-Title">
							<th  width="10%">手机号码</th>
							<th>短信内容</th>
							<th  width="16%">发送时间</th>
							<th  width="10%">认证日志ID</th>				
						</tr>
						<tbody id="smslist_body"></tbody>
					</table>
				</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/merchant/js/smssentmgmt.js"></script>
