...
<div class="ChinaNet-Free-Menu-Left">
    <a href="/merchant/smspurchasemgmt26.htm" id="smspurchasemgmt" class="initAjax Active"><span>短信消费</span></a>
    <a href="/merchant/smsmanagement26.htm" id="smsmanagement" class="initAjax"><span>短信管理</span></a>
    <a href="/authentication/setwechataccountpage26.htm" id="setwechataccountpage" class="initAjax"><span>微信公众号设置</span></a>
</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/merchant/js/smspurchase_mgmt.js"></script>
