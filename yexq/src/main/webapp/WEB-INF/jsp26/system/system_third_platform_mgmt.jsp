...
<div class="Page-Navigator-Body">
    ...
    <a href="#">系统设置</a>
    <a href="#">二级平台管理</a>
    <a href="/platform10/registerthirdplatformpage26.htm" class="Action-Primary End-Button ChinaNet-Right initAjax">注册二级平台</a>
</div>
<!-- ./Navigator -->
<div class="ChinaNet-Free-Menu-Left">    	
    ...
    <a href="/platform10/searchthirdplatformpage26.htm" id="searchthirdplatformpage" class="initAjax Active"><span>二级平台管理</span></a>
    ...
    <div id="systemBody" class="Right-Body-Main">
        <div class="ChinaNet-Search-Body">
            <div class="ChinaNet-Form-Sheet">
                ...
                <div class="ChinaNet-Col-1 ChinaNet-Left">
              		<button id="btn_search_third_platform" class="Form-Primary"><span>查询</span></button>
          		</div>   		
        ...
        <div class="Statis-Body">
            <div class="Statis-Body-Guest">
				<div id="third_platform_list" class="ChinaNet-Free-Table">
					<table>
						...
						<tbody id="third_platform_list_body"></tbody>
					</table>
				</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/merchant/js/thirdplatformmgmt.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/merchant/js/chinanet.js"></script>
<script type="text/javascript">
	$(document).ready(function(){
		thirdPlatformMgmtApp.init();
	 });
</script> 