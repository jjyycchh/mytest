...
<div class="ChinaNet-Free-Menu-Left">      
    ...
    <a href="/system/accountoperationlogpage26.htm" id="accountoperationlogpage" class="initAjax Active"><span>操作日志记录</span></a>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/merchant/js/accountoperationlog.js"></script>
