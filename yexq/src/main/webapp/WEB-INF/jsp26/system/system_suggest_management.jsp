...
<div class="ChinaNet-Free-Menu-Left">
    ...
    <a href="/system/searchsuggestpage26.htm" id="searchsuggestpage" class="initAjax Active"><span>投诉与建议管理</span></a>
</div>
    ...
    <div id="systemBody" class="Right-Body-Main">
        <div class="ChinaNet-Search-Body">
            <div class="ChinaNet-Form-Sheet">
				...
				<div class="ChinaNet-Col-1 ChinaNet-Left">
              		<button id="btn_search_suggest" class="Form-Primary"><span>查询</span></button>
          		</div>
        ...
        <div class="Statis-Body">
            <div class="Statis-Body-Guest">
				<div id="suggest_list" class="ChinaNet-Free-Table">
					<table>
						...
						<tbody id="suggest_list_body"></tbody>
					</table>
				</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/merchant/js/suggestmgmt.js"></script>
<script type="text/javascript">
	$(document).ready(function(){
		suggestsearchApp.init();
	 });
</script>