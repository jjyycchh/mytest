...
<div class="ChinaNet-Free-Menu-Left">
    <a href="/user/onlineusersuccess.htm" id="useronline" class="initAjax Active"><span>当前在线用户</span></a>
    ...
    <a href="/user/blacklistsuccess.htm" id="userblacklist" class="initAjax"><span>黑名单用户管理</span></a>
        ...
        <div id="userstab" class="ChinaNet-Free-Table">
            <table>
                <tr class="ChinaNet-Table-Title">
                    <th width="30%">用户手机号</th>
                    <th width="42%">最新登录时间</th>
                    <th width="20%">用户标志</th>
