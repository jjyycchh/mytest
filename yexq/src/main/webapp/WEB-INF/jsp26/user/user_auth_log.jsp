...
<div class="ChinaNet-Free-Menu-Left">
    <a href="/user/users26.htm" id="usermanagement" class="initAjax"><span>用户管理</span></a>
...
<!-- Page Line -->
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/merchant/js/userauthlog.js"></script>
