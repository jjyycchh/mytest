...
<link type="text/css" href="/resources/merchant/css/login21.css" rel="stylesheet" media="screen" />
</head>
<body>
<div class="ChinaNet-Login-Header">
<div class="ChinaNet-Login-Header-Body">
<div class="ChinaNet-Login-Logo"><img src="/resources/merchant/img/login21/logo.jpg" alt="接入系统平台3.0" /></div>
<div class="ChinaNet-Login-Telephone"><img src="/resources/merchant/img/login21/telephone.gif" alt="" /></div>
<div class="ChinaNet-Login-Partners"><a href="/devicelist26.html" target="_blank">联盟终端合作伙伴</a></div>
</div>
</div>
...
<div class="Register"><a href="/account/register_account26.htm?">商户注册</a></div>
</div>
...
<script type="text/javascript" src="/resources/merchant/js/login.js"></script>
