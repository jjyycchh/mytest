...
<head lang="en">
    ...
    <link type="text/css" href="${pageContext.request.contextPath}/resources/merchant/css/devreg.css" rel="stylesheet" media="screen">
</head>
<!--[if lt IE 9]>
<script>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/merchant/js/deviceregister.js"></script>
