...
<div class="Page-Navigator-Body">
    ...
    <a href="/authentication/thirdapplicationsearchpage26.htm" class="initAjax Action-Primary ChinaNet-Right">第三方应用管理</a>
</div>
<!-- ./Navigator -->
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/merchant/js/thirdapplicationtypemgmt.js"></script>
