...
<div class="Page-Navigator-Body">
    ...
    <a href="#">系统设置</a>
    <a href="#">第三方应用管理</a>
    <a href="/authentication/thirdapplicationtype26.htm" class="initAjax Action-Primary ChinaNet-Right">第三方应用类型管理</a>
</div>
<!-- ./Navigator -->
<div class="ChinaNet-Free-Menu-Left">    	
    ...
    <a href="/authentication/thirdapplicationsearchpage26.htm" id="thirdapplicationsearchpage" class="initAjax Active"><span>第三方应用管理</span></a>
</div>
        ...
        <div class="ChinaNet-Search-Body">
            <div class="ChinaNet-Form-Sheet">
                ...
                <div class="ChinaNet-Col-1 ChinaNet-Left">
              		<button id="btn_search_third_application" class="Form-Primary"><span>查询</span></button>
          		</div>
          		<div class="ChinaNet-Col-1 ChinaNet-Left">
              		<button id="btn_add_third_application" class="Form-Important"><span>添加</span></button>
          		</div>   	
            </div>
        </div>            
        <div class="Statis-Body">
            <div class="Statis-Body-Guest">
				<div id="third_application_list" class="ChinaNet-Free-Table">
					<table>
						...
						<tbody id="third_application_list_body"></tbody>
					</table>
				</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/merchant/js/thirdapplicationmgmt.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/merchant/js/chinanet.js"></script>
<script type="text/javascript">
	$(document).ready(function(){
		thirdApplicationMgmtApp.init();
	 });
</script> 