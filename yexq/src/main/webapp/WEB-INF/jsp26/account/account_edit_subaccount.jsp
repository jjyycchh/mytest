...
<div class="Page-Navigator-Body">
    ...
    <a href="/account/viewaccountdetails26.htm?accountId=${accountId}" class="Action-Primary End-Button ChinaNet-Right initAjax">返回帐号信息</a>
</div>
<!-- ./Navigator -->
                                ...
                                <div class="ChinaNet-Free-Table">
                                    <table>
                                        ...
                                        <tr class="Edit-Left-Table-Body">
                                            <td class="Table-Name-Photo-Td ChinaNet-Col-12" colspan="2"><img id="AccountAvatarImgsrc" src="/resources/merchant/img/no-image.png" height="180" width="180"></td>
                                        </tr>
                                        <tr class="Edit-Left-Table-Body">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/merchant/js/subAccount.js"></script>
