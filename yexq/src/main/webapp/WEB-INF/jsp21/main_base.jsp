...
<meta name="viewport" content="width=device-width, initial-scale=1.0" charset="utf-8">
	...
	<link type="text/css" href="${pageContext.request.contextPath}/statics/css/jquery-ui-1.8.3.css" rel="stylesheet" media="screen">
	...
	<link type="text/css" href="${pageContext.request.contextPath}/statics/css/jquery-ui-timepicker-addon.css" rel="stylesheet" media="screen">
	<!--[if lt IE 9]>
	<script>
...
<body>
    ...
    <div class="ChinaNet-Free-Header">
        <div class="Header-Body ChinaNet-Free-Width">
            ...
            <div class="Header-Body-Menu">
                <div class="ChinaNet-WIFI-Menu">
                    <s:if test="#session.login_account_info.type != 'MANUFACTURER' && #session.login_account_info.type != 'DEVICE_ADMIN'">
                    	<a href="/account/home.htm" class="Active"><span>帐号概览</span></a>
                    	<a href="/device/devicelist.htm" class="menuAjax"><span>设备管理</span></a>
                    	<a href="/merchant/sites.htm" class="menuAjax Has-Child"><span>门户站点</span></a>
                    	<a href="/user/users.htm" class="menuAjax Has-Child"><span>用户管理</span></a>
                    	<a href="/system/statistics.htm" class="menuAjax Has-Child"><span>统计分析</span></a>
                    	<s:if test="#session.login_account_info.type != 'MERCHANT'">
                    		<a href="/account/account_management.htm" class="menuAjax"><span>帐号管理</span></a>
         				</s:if>
                    	<s:if test="#session.login_account_info.type == 'MERCHANT'">
                    		<a href="/merchant/smspurchasemgmt.htm" class="menuAjax Has-Child"><span>商户设置</span></a>
                    		<a href="/authentication/merchanthasthirdapplicationpage.htm" class="menuAjax"><span>商户应用</span></a>
                    	</s:if>
                    </s:if>
                    
                    <s:if test="#session.login_account_info.type == 'SUPER_MAN'">
                    	<a href="/system/platformsettings.htm" class="menuAjax Has-Child"><span>系统设置</span></a>
                    </s:if>
                    <s:if test="#session.login_account_info.type == 'MANUFACTURER' || 
                    	...
                    	<a href="/system/searchdevicepage.htm" class="menuAjax Has-Child"><span>厂商设备</span></a>
                    </s:if>                    
            	</div>
            </div>
            ...
            <div class="Header-Body-Account">
                <a href="javascript:;">
                    <div class="Avatar-Frame">
                        <img src="${pageContext.request.contextPath}/statics/img/avatar-demo.png" id='AccountAvatarImg'>
            ...
            <div class="Account-Menu-Dropdown" id="ChinaNetAccountDropdown">
               ...
               <!--   <a href="/system/get_message.htm" id="showmsg" class="initAjax">系统信息<span class="glyphicon glyphicon-envelope"></span></a>-->
                 
                <s:if test="#session.login_account_info.type != 'MANUFACTURER' && #session.login_account_info.type != 'DEVICE_ADMIN'">
                	<a href="/system/get_message.htm" id="showmsg" class="initAjax">
                   		<div>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/jquery.blockUI.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/artDialog/dist/dialog-min.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/highcharts/js/highcharts.js"></script>
    <script type="text/javascript" src="${pageContent.request.contextPath}/statics/js/jquery.menu.js"></script>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/deviceRefresh.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/chinanet.js"></script>
    
    <script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/pager.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/jquery-file-upload/js/vendor/jquery.ui.widget.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/jquery-file-upload/js/jquery.iframe-transport.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/jquery-file-upload/js/jquery.fileupload.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/fileupload.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/headeraccount.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/jquery-ui-timepicker-addon.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/jquery-ui-timepicker-zh-CN.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/smsmessage.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/report.js"></script>
    <!--[if (gte IE 8)&(lt IE 10)]>
	<script src="${pageContext.request.contextPath}/statics/js/jquery-file-upload/js/cors/jquery.xdr-transport.js"></script>
	<![endif]-->
    <script type="text/javascript">
