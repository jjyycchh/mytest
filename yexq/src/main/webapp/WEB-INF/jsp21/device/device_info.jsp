...
<link type="text/css" href="${pageContext.request.contextPath}/statics/css/device.css" rel="stylesheet" media="screen">
	<!-- Navigator -->
<div class="Page-Navigator-Body">
    <a href="/account/home.htm" class="Home">接入系统管理平台</a>
    <a href="/device/devicelist.htm" class="initAjax">设备管理</a>
	<a href="#">设备信息</a>
...
<!-- Data Content Tab -->
<script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/deviceinfo.js"></script>
