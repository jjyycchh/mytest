...
<head lang="en">
    ...
    <link type="text/css" href="/statics/css/xiSelect.css" rel="stylesheet" media="screen">
    <link type="text/css" href="/statics/css/chinanet-free.css" rel="stylesheet" media="screen">
    <link type="text/css" href="/statics/css/devreg.css" rel="stylesheet" media="screen">
</head>
<!--[if lt IE 9]>
<script>
...
<script type="text/javascript" src="/statics/js/address.js"></script>
<script type="text/javascript" src="/statics/js/chinanet.js"></script>
<script type="text/javascript" src="/statics/js/deviceregister.js"></script>

<script type="text/javascript">
	
	// var gw_address = "192.168.10.1";
	// var gw_port = "2060";
	// var gw_mac = "8C882B10F049";
	// var componentVer = "1.0.0";
	
	var gw_address = "<%=request.getAttribute("gw_address")%>";
	var gw_port = "<%=request.getAttribute("gw_port")%>";
	var gw_mac = "<%=request.getAttribute("gw_mac")%>";
	var componentVer = "<%=request.getAttribute("ver")%>";
