...
<head>
    ...
    <link type="text/css" href="/statics/css/editpage.css" rel="stylesheet" media="screen">
    <!--[if lt IE 9]>
    <script>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/templates.js"></script>
