...
<div class="Page-Navigator-Body">
    ...
    <a href="/merchant/addportalpolicy.htm" class="Action-Primary ChinaNet-Right initAjax">添加新策略</a>
</div>
<!-- ./Navigator -->
        ...
        <div class="Policy-Form-Editor-Body Data-Adorn-Overly">
            ...
            <div class="Policy-Editor-Plan-Body">
                <div class="Policy-Data-Body">
                    ...
                    <a href="/merchant/editportalpolicy.htm?policyId=${policyId}" title="刷新策略" class="Refresh-Icon initAjax">&nbsp;</a>
                </div>
            ...
            <div class="Policy-Editor-Base-Body">
                <div class="Policy-Data-Body">
                    ...
                    <div class="Policy-Data-Info" id="PolicyDataInfoSite"></div>
                    <div class="Policy-Data-Info" id="PolicyDataInfoDevice"></div>
                    <a href="/merchant/editportalpolicy.htm?policyId=${policyId}" class="Refresh-Icon initAjax">&nbsp;</a>
                </div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/merchant/portalpolicyedit.js"></script>
