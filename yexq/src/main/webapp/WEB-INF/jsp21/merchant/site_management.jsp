...
<div class="Page-Navigator-Body">
    ...
    <a href="/merchant/sites.htm" class="initAjax">门户站点管理</a>

    <a href="/merchant/addsite.htm" class="Action-Primary ChinaNet-Right End-Button initAjax">添加新站点</a>
</div>
<!-- ./Navigator -->
...
<div class="ChinaNet-Free-Menu-Left">
    <a href="/merchant/sites.htm" id="sites" class="initAjax Active"><span>门户站点管理</span></a>
