...
<div class="Page-Navigator-Body">
    ...
    <a href="/merchant/sites.htm" class="initAjax">WIFI站点管理</a>
    <a href="#">编辑站点</a>

    <a href="/merchant/sites.htm" class="Action-Primary End-Button ChinaNet-Right initAjax">返回站点列表</a>
    <!--<a href="/merchant/editsite.htm?siteid=${siteid}" class="Action-Primary ChinaNet-Right initAjax">重新加载当前页面</a>-->
    <a href="/merchant/addsite.htm" class="Action-Primary ChinaNet-Right initAjax">添加新站点</a>
</div>
<!-- ./Navigator -->

<!-- Left Menu -->
<div class="ChinaNet-Free-Menu-Left">
    <a href="/merchant/sites.htm" id="sites" class="initAjax Active"><span>Portal站点管理</span></a>
    <a href="/merchant/portalpolicies.htm" id="portalpolicies" class="initAjax"><span>站点推送策略</span></a>
</div>
<!-- ./Left Menu -->
                ...
                <form action="/merchant/sitedetails.htm" method="POST" id="FormSiteDetialSave">
                    ...
                    <div class="Portal-Detail-Body-Easy">
                        <div class="Portal-Site-Thumb Data-Adorn-Overly">
                            ...
                            <img src="/statics/img/no-image.png" id="SiteThumbID">
                        </div>
                        ...
                        <div class="Portal-Site-Number ChinaNet-Right Data-Adorn-Overly">
                            ...
                            <div class="Overly-Bottom-Right"></div>
                            <span>已被推送</span>
                            <span class="Data-Number" id="SiteResponseNumber">3230</span>
                        </div>
                        <div class="Portal-Site-Number ChinaNet-Right Data-Adorn-Overly">
                            <div class="Overly-Top-Left"></div>
                            <div class="Overly-Top-Right"></div>
                            ...
                            <div class="Overly-Bottom-Right"></div>
                            <span>关联设备</span>
                            <span class="Data-Number" id="SiteRelationDevices">28</span>
                        </div>
                        <div class="Portal-Site-Number ChinaNet-Right Data-Adorn-Overly">
                            <div class="Overly-Top-Left"></div>
                            <div class="Overly-Top-Right"></div>
                            ...
                            <div class="Overly-Bottom-Right"></div>
                            <span>页面数量</span>
                            <span class="Data-Number" id="SiteInitPagesNubmer">3</span>
                        </div>
                    </div>
                    <!-- ./Site Detail Issue -->
        ...
        <div class="ChinaNet-Portal-Editor-Page">
            <div class="Page-Editor-Header Data-Adorn-Overly">
                ...
                <div class="Page-Template-Change-Body">
					<span class="Page-Template-Tips">请在下面模板列表中选择你需要的模板</span>
                    <a href="javascript:;" class="ChinaNet-Left Page-Template-Type Template-Type-LOGIN">
                        <span class="Type-Icon"></span>
                        <span>登录页</span>
                        <span class="Type-Select"></span>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/portal.js"></script>
