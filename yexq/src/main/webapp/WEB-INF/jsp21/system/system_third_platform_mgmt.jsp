...
<div class="Page-Navigator-Body">
    ...
    <a href="#">系统设置</a>
    <a href="#">二级平台管理</a>
    <a href="/platform10/registerthirdplatformpage.htm" class="Action-Primary End-Button ChinaNet-Right initAjax">注册二级平台</a>
</div>
<!-- ./Navigator -->
...
<script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/thirdplatformmgmt.js"></script>
