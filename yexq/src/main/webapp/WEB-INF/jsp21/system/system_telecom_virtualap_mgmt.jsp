...
<div class="ChinaNet-Free-Menu-Left">      
    ...
    <s:if test="#session.login_account_info.type != 'MANUFACTURER'">
    	...
    	<a href="/system/tcappage.htm" id="tcappage" class="initAjax Active"><span>电信虚拟设备管理</span></a>
    </s:if>
</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/telecomvirtualap.js"></script>
