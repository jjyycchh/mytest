...
<div class="ChinaNet-Free-Menu-Left">
    ...
    <a href="/system/searchreportpage.htm" id="searchreportpage" class="initAjax Active"><span>举报记录管理</span></a>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/reportmgmt.js"></script>
