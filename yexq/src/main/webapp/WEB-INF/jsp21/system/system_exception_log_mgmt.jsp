...
<div class="ChinaNet-Free-Menu-Left">
    ...
    <a href="/system/searchexceptionlogpage.htm" id="searchexceptionlogpage" class="initAjax Active"><span>异常日志管理</span></a>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/superelogmgmt.js"></script>
