...
<div class="Page-Navigator-Body">
    ...
    <a href="/system/get_message.htm" class="initAjax">系统信息</a>
    <a href="#">已发信息</a>
</div>
<div class="ChinaNet-Free-Menu-Left">
    <a href="/system/get_message.htm" id="showmsg" class="initAjax "><span>收件箱</span></a>
    <a href="/system/sentmessage.htm" id="sentmsg" class="initAjax Active"><span>已发信息</span></a>
    <a href="/system/sendoutmessage.htm" id="savemsg" class="initAjax"><span>发送信息</span></a>
</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/sentmessage.js"></script>
