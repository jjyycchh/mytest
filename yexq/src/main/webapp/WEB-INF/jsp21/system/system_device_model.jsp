...
<div class="Page-Navigator-Body">
    ...
    <a href="/system/searchdevicepage.htm" class="initAjax">厂商设备</a>
    <a href="#">品牌型号管理</a>
</div>
<!-- ./Navigator -->
...
<script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/devicemodel.js"></script>
