...
<div class="ChinaNet-Free-Menu-Left">
    ...
    <a href="/system/searchsuggestpage.htm" id="searchsuggestpage" class="initAjax Active"><span>投诉与建议管理</span></a>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/suggestmgmt.js"></script>
