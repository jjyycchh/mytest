...
<div class="Page-Navigator-Body">
    ...
    <a href="/system/searchproduceddevicespage.htm" class="initAjax">厂商设备</a>
    <a href="#">在库设备管理</a>
</div>
<!-- ./Navigator -->
<div class="ChinaNet-Free-Menu-Left">    	
    ...
    <a href="/system/searchproduceddevicespage.htm" id="producedDevicesSearchPage" class="initAjax Active"><span>在库设备管理</span></a>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/produceddevices.js"></script>
