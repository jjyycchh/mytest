...
<div class="ChinaNet-Free-Menu-Left">      
    ...
    <s:if test="#session.login_account_info.type != 'MANUFACTURER'">
        <a href="/system/radiusvirtualdevicepage.htm" id="radiusvirtualdevicepage" class="initAjax"><span>AAA认证设备管理</span></a>
        <a href="/system/fitapdevicepage.htm" id="fitapdevicepage" class="initAjax Active"><span>Fit-Ap设备管理</span></a>
    ...
    <div id="systemBody" class="Right-Body-Main">
        <div class="ChinaNet-Search-Body">
            <div class="ChinaNet-Form-Sheet">
                <div class="Form-Item-Input ChinaNet-Col-6">
                    <input type="text" id="keywords" class="Input-Control" placeholder="查询关键字，如设备ID、MAC等，多个关键字请用空格隔开">
                </div>
        ...
        <div class="Statis-Body">
            <div class="Statis-Body-Guest">
                <div id="fit_ap_list" class="ChinaNet-Free-Table">
                    <table>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/fitapdevice.js"></script>
