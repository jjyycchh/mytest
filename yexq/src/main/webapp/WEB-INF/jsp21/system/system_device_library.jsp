...
<div class="ChinaNet-Free-Menu-Left">    	
    <a href="/system/searchdevicepage.htm" id="deviceSearchPage" class="initAjax Active"><span>已注册设备查询</span></a>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/devicelibrary.js"></script>
