...
<link type="text/css" href="${pageContext.request.contextPath}/statics/css/thirdapp.css" rel="stylesheet" media="screen">
<!-- Navigator -->
...
<div class="ChinaNet-Free-Menu-Left">
    <a href="/authentication/merchanthasthirdapplicationpage.htm" id="asthirdapp" class="initAjax Active"><span>我的应用</span></a>
    <a href="/authentication/merchantthirdapplicationpage.htm" id="thirdapp" class="initAjax"><span>应用商城</span></a>
</div>
<!-- ./Navigator -->
<!-- Search -->
