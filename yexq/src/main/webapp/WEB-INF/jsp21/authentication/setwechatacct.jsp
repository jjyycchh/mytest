...
<div class="ChinaNet-Free-Menu-Left">
    ...
    <a href="/authentication/setwechataccountpage.htm" id="setwechataccountpage" class="initAjax Active"><span>微信公众号设置</span></a>
</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/setwechatacct.js"></script>
