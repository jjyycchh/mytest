...
<div class="Page-Navigator-Body">
    ...
    <a href="#">系统设置</a>
    <a href="#">第三方应用管理</a>
    <a href="/authentication/thirdapplicationtype.htm" class="initAjax Action-Primary ChinaNet-Right">第三方应用类型管理</a>
</div>
<!-- ./Navigator -->
...
<script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/thirdapplicationmgmt.js"></script>
