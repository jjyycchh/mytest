...
<div class="ChinaNet-Free-Menu-Left">
    <a href="/user/users.htm" id="usermanagement" class="initAjax"><span>用户管理</span></a>
    <a href="/user/userauthlog.htm" id="userlogmanagement" class="initAjax"><span>用户授权日志</span></a>
</div>
...
<!-- Page Line -->
<script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/userauthlog.js"></script>
